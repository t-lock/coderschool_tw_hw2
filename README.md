# Homework 2 - *Chatterbox*

**Chatterbox** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.
...
* run rails chatterbox:generate_users to generate the rest of users
...
- [x] Custom Illustrated logo which nicely fits the brand (took forever but was fun, I will probably stop doing this to spend more time on rails)
